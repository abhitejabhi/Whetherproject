...
function renderWeatherInfo(weatherInfo) {
    ...
    // Display wind speed in m/s (you can format it as needed)
    windspeed.innerText = `Wind Speed: ${weatherInfo?.wind?.speed} m/s`;

    // Display humidity percentage
    humidity.innerText = `Humidity: ${weatherInfo?.main?.humidity} %`;

    cloudiness.innerText = `Cloudiness: ${weatherInfo?.clouds?.all}%`;
}
